...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="/datareligion" class="nav-link">Agama</a>
      </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="/datadepartment" class="nav-link">Departemen</a>
      </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="/datajob" class="nav-link">Pekerjaan</a>
      </li>
    <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Data Pegawai laravel</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('template/dist/img/SC.png') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/datadepartment" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Data Departemen
              </p>
