...
<div class="content-wrapper">
    ...
    <div class="container">
        <a href="/tambahjob" type="button" class="btn btn-secondary active">Tambah</a>
        <a href="/softjob" type="button" class="btn btn-secondary active">Riwayat Penghapusan</a>
            ...
            <table class="table">
                ...
                @foreach ($data as $index => $row)
                    <tr>
                        ...
                        <td>Rp.{{ $row->gaji }}</td>
                        <td>
                            <a href="/tampilkandatajob/{{ $row->id }}" class="btn btn-secondary active">Edit</a>
                            <a href="#" type="button" class="btn btn-secondary active delete" data-id="{{ $row->id }}" data-nama="{{ $row->nama }}">Delete</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
...
<script>
    $('.delete').click( function(){
        ...
        .then((willDelete) => {
            if (willDelete) {
                window.location = "/deletejob/"+pekerjaanid+" "
                swal("Pegawai "+nama+" "+"berhasil di Hapus", {
                    icon: "success",
                });
            } else {
