    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <p class="text-center display-4"><strong>Welcome</strong></p>
          <div class="col">
            <div class="col text-center">
                <div class="card">
                    <div class="image">
                      <img src="{{ asset('template/dist/img/slavery.png') }}" class="img elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                      <span href="#" class="display-4"><strong>Data <del>Perbudakan</del> Pegawai</strong></span>
                    </div>
                  </div>
